...
if __name__ == "__main__":
    ...
    layer_configs = [
        ...
        {
            'name': 'visual.blocks.{}.attn.proj.weight',
            'range': range(layer_start, layer_end),
            'label': 'Vision Proj'
        },
        {
            'name': 'visual.blocks.{}.mlp.gate_proj.weight',
            'range': range(layer_start, layer_end),
            'label': 'Vision MLP Gate'
        },
        {
            'name': 'visual.blocks.{}.mlp.up_proj.weight',
            'range': range(layer_start, layer_end),
            'label': 'Vision MLP Up'
        },
        {
            'name': 'visual.blocks.{}.mlp.down_proj.weight',
            'range': range(layer_start, layer_end),
