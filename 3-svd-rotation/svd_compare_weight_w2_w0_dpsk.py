...
def plot_layer_mse_curves(layer_configs, output_path="rotation_mse_curves.png"):
    ...
    ax.set_ylabel('Weight MSE (W2 vs W0)', fontsize=12, fontweight='bold')
...
if __name__ == "__main__":
    ...
    output_path = "dpsk_w2_w0_weights_mse_curves_language.png"
    
    layer_configs = [
        {
            'name': 'layers.{}.self_attn.q_proj.weight',
            'range': range(layer_start, layer_end),
            'label': 'Language Q'
        },
        {
            'name': 'layers.{}.self_attn.k_proj.weight',
            'range': range(layer_start, layer_end),
            'label': 'Language K'
        },
        {
            'name': 'layers.{}.self_attn.v_proj.weight',
            'range': range(layer_start, layer_end),
            'label': 'Language V'
        },
        {
            'name': 'layers.{}.self_attn.o_proj.weight',
            'range': range(layer_start, layer_end),
            'label': 'Language O'
        },
        {
            'name': 'layers.{}.mlp.down_proj.weight',
            'range': range(layer_start, layer_end),
            'label': 'Language MLP Down'
        },
        {
            'name': 'layers.{}.mlp.gate_proj.weight',
            'range': range(layer_start, layer_end),
            'label': 'Language MLP Gate'
        },
        {
            'name': 'layers.{}.mlp.up_proj.weight',
            'range': range(layer_start, layer_end),
